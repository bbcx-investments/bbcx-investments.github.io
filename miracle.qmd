...
The following interactive webpage presents present value calculations.
...
```{=html}
<iframe width="1200" height="600" src="https://bbcx-investments.com/borrowing-saving/npv" title="BBCX Investments"></iframe>
```
