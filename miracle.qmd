...
These are standard questions, and their answers -- which are obtained by solving the above equation -- are provided by online financial calculators and by the Excel and numpy_financial functions PMT, PV, and RATE.

For loans with monthly payments, we need to input the number of months as the number of periods and the monthly rate as the rate.  
For example, for a 30-year mortgage at a rate of 6\%, we would input $30 \times 12$ as the number of periods and $0.06/12$ as the rate.
