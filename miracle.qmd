...
Complications can arise when the sequence of cash flows changes sign more than once, for example, when there is a deposit then a withdrawal then another deposit and then another withdrawal.  In such situations, there may be multiple rates of return for which the NPV is zero or there may be no rate of return for which the NPV is zero.
