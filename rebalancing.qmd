...
### Taxes {.unnumbered}
Unless an investor has additional capital to newly invest, rebalancing entails selling securities that have done relatively well and buying assets that have done relatively poorly.  In practice, these trades are not costless.  If the assets are held in a taxable account, selling   securities that have done well will result in capital gains taxes, so the potential benefit of improved portfolio allocation needs to be weighted against potential tax exposure of selling overweighted assets.  

To the extent an investor has holdings in tax-advantaged accounts, tax consequences of rebalancing may be reduced or eliminated by rebalancing with trades in these acch h hgounts.  Some investors may regularly have new capital to invest.  For instance, individuals that save and invest a regular amount each month can use this new capital to rebalance their portfolio.  To do so, the new capital can be invested in the underweight securities.
