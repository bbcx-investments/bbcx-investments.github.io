...
# Optimal Portfolios: Sensitivity to Inputs
...
Est-SD (risk parity) performs the best in terms of Sharpe ratio in the thirty or so years of implementing each strategy, followed by the Est-None and Est-SD-Corr strategies.  For this set of assets and sample, estimating differences in volatility across assets was beneficial to performance.  However, estimating correlations in addition to volatilities led to worse outcomes in terms of Sharpe ratios.  In fact, Est-SD-Corr underperformed both the Est-SD and Est-None strategies.
