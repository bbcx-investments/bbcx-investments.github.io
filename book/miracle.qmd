...
Thus, the inputs are $m$, $n$, $r$, $B_0$, $g$, $D_1$, and $W$.  @fig-retirement presents an example with $m=360$, $n=720$, $r=0.005$, $B_0 = \text{100,000}$, $g=0.001$, $D_1 = \text{1,000}$, and $W = \text{10,000}$.  To select the inputs for an interactive figure, see [https://bbcx-investments.com](https://bbcx-investments.com).

```{python}
#| label: fig-retirement
#| fig-cap: "Retirement Account"
...
::: callout-tip
## Calculating the ending balance in terms of future values
We can compute the ending balance as a sum of future values: the future value of the initial balance plus the future values of the deposits minus the future values of the withdrawals.  
