...
::: callout-tip
## FV and PV factors in python

The numpy arange function makes it easy to create sequences (arrays) of future value and present value factors.  
``` p
import numpy as np
n = 30
r = 0.08
