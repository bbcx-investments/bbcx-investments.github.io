...
We also call $1 the present value of $(1+r)^n$.  It is how much you need to invest to reach $(1+r)^n$ in $n$ years when the rate of return is $r$.  More generally, we call $x$ the [present value]{style="color: Tomato;"} of $y$, and we call $y$ the [future value]{style="color: Tomato;"} of $x$ when $x$ and $y$ are related as 
...
$$x = \frac{y}{(1+r)^n},$$
we can also compute the present value $x$ from the future value $y$ by dividing by $(1+r)^n$ or, equivalently, by multiplying by $1/(1+r)^n$.  Consequently, we call $1/(1+r)^n$ the [present value factor]{style="color: Tomato;"} (or discount factor).  The operation of multiplying by the discount factor is called discounting, and the operation of multiplying by the future value factor is called compounding.  We also call the rate of return $r$ the discount rate.
...
<p style="background-color:DodgerBlue; color:White">A highlighted block of text...</p>
