...
## Diversification and N-Asset Portfolios {#sec-n-risky}
...
From @eq-2asset-variance, we see that the variance of portfolio $r_p$ with non-negative $w_{\text{risky}}$ invested in the risky asset and $1-w_{\text{risky}}$ invested in the risk-free rate is:
\begin{align}
...
## Preferences and a Single Risky Asset CAL
...
## Preferences and the Tangency CAL


## Preferences and Capital Allocation with Differential Borrowing & Lending Rates
